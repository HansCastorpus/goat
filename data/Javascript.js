...
info.update = function (props) {
  this._div.innerHTML =
    "<h4>LAND USE and Wild Horse/Burro and Sheep/Goat Population in Western United States</h4>" +
    (props
      ? "<b>" +
        props.name +
        "</b><br />" +
        props.density +
        " people / mi<sup>2</sup>"
      : "Wild Horse/Burro Land compared to Goat/Sheep Land with a reference to National Forest Land");
};
...
legend.onAdd = function (map) {
  ...
  div.innerHTML +=
    '<i style="background: #b78390"></i><span>Goat and Sheep Land</span><br>';
  div.innerHTML +=
    '<i style="background: #8996ab"></i><span>Wild Horse and Burro Land</span><br>';
  div.innerHTML +=
    '<i style="background: #6d617c"></i><span>Overlay of Both Land</span><br>';
  div.innerHTML +=
    '<i style="background: #bccbba"></i><span>National Forest</span><br>';
  div.innerHTML +=
    '<i class="icon" style="background-image: url(https://hanscastorpus.github.io/goat/PNG/Animals.png);background-repeat: no-repeat;"></i><span>Animal Population</span><br>';
