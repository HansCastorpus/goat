  ...
  features: [
    {
      type: "Feature",
      id: "04",
      properties: { name: "Arizona", density: 9496 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "06",
      properties: { name: "California", density: 10140 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
    ...
    },
    {
      type: "Feature",
      id: "08",
      properties: { name: "Colorado", density: 1873 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "16",
      properties: { name: "Idaho", density: 555 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "30",
      properties: { name: "Montana", density: 195 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "32",
      properties: { name: "Nevada", density: 46570 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "35",
      properties: { name: "New Mexico", density: 272 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "41",
      properties: { name: "Oregon", density: 4532 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "49",
      properties: { name: "Utah", density: 4017 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
...

    {
      type: "Feature",
      id: "56",
      properties: { name: "Wyoming", density: 4734 },
      geometry: {
        type: "Polygon",
        coordinates: [
          [
